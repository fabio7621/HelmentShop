        ...
        <div class="col-12">
          <div class="article-item">
            ...
            <div class="article-content">
              <h4>關於我</h4>
              <p>
                我畢業於設計科系做個做過不同領域工作的轉職者，因為弟弟是一位後端工程師，推薦我往
                UI方面發展因為我原本設計專長相關的方向發展。在學習過程因為設計頁面也是必須了解網頁flex特性與組件化設計。所後來參加了
                Amos(CSScoke)老師的課程，後來也找到現在前端切版工作,
                這當中對於前端切版有更。多了解也因為接觸了更多故開始學習前端方面技能樹Js
                Vue React等等 ,
                目前積極尋找更專業的資訊公司往前端做更深入的耕耘發展。
                目前是好想工作室WebCamp 十七屆的學員，持續精進前端技能中。
              </p>
            </div>
          </div>
        </div>
